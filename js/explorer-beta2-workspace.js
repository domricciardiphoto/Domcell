    ...
    if (!$(targetElement).is('.edit-mode')) {
        ...
        var input = $('<input>', {
            ...
            blur: function() {
                ...
                runexplorer2();  // Refresh the explorer view if needed
            },
            keyup: function(e) {
                if (e.key === 'Enter') {
...
function runexplorer2() {
    $('#explorer2').empty();    // Clear the existing content
    const target2 = document.getElementById('pullthecode3');
    const explorer2 = document.getElementById('explorer2');
    ...
    function exploreElements(element, depth = 0, parentContainer = explorer2) {
        ...
        for (let i = 0; i < elements.length; i++) {
            ...
            // Store a reference to the explorer2 indent on the DOM element for easy access
